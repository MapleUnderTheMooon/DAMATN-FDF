...
class PAM_Module(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x.view(m_batchsize, C, height * width, deep)
        # torch.Size([4, 128, 196, 10])
        ...
        return out.view(m_batchsize, C, height, width, deep)
...
if __name__ == '__main__':
    # semanticModule_1_1 = semanticModule(128)
    # x1 = torch.randn(4, 128, 88, 88)
    # output1, output2 = semanticModule_1_1(x1)
    # print(output1.size())
    # print(output2.size())
    test = torch.randn(4, 4, 4)
    weight = softmax = nn.Softmax(dim=-1)
    print(test)
    print(weight(test))
