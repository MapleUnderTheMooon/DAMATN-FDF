...
listt = glob('E:/PyCharmProjects/UA-MT-master/data/image/*')

for item in tqdm(listt):
    name_image = str(item)
    name_label = name_image.replace('image', 'label')
    name_label = 'E:/PyCharmProjects/UA-MT-master/data/TCIA_pancreas_labels-02-05-2017/' + name_label[-16:]
    #     pdb.set_trace
    ...
    print(image.shape)
    f = h5py.File(('E:/PyCharmProjects/UA-MT-master/data/Pancreas_h5/' + name_image[-16:-7] + '_norm.h5'), 'w')
